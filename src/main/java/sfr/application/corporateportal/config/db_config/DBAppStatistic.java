...
@EnableJpaRepositories(
        entityManagerFactoryRef = DBAppStatistic.ENTITY_MANAGER_FACTORY,
        transactionManagerRef = DBAppStatistic.TRANSACTION_MANAGER,
        basePackages = DBAppStatistic.JPA_REPOSITORY_PACKAGE
)
@Configuration
